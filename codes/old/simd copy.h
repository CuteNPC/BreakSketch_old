...
static uint32_t __attribute__((aligned(64))) num3_32[16] =
...
static uint16_t __attribute__((aligned(64))) num3_16[32] =
...
public:
    ...
    int Insert(uint32_t visitnum)
    {
        ...
        __m128i m128i_diff3res = _mm_cmpgt_epi32(*(__m128i *)num3_32, m128i_diff);
        ...
        res = matchplace < 4 ? visitnum - ((uint32_t *)&m128i_num)[matchplace] > 3 : 2;
...
public:
    ...
    int Insert(uint32_t visitnum)
    {
        ...
        __m256i m256i_diff3res = _mm256_cmpgt_epi32(*(__m256i *)num3_32, m256i_diff);
        ...
        matchplace = tailzero / 4;
        res = matchplace < 8 ? (visitnum - ((uint32_t *)&m256i_num)[matchplace] > 3) : 2;
        // 效率低，可能需要改进
